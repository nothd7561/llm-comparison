...
model_1 = input("First Model: ")
model_2 = input("Second Model: ")
...
stats1 = match1[['prompt_pricing', 'completion_pricing', 'context_length', 'max_completion_tokens', 'is_moderated']]
stats2 = match2[['prompt_pricing', 'completion_pricing', 'context_length', 'max_completion_tokens', 'is_moderated']]
